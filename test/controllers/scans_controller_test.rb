...
class ScansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scan" do
    assert_difference("Scan.count") do
      post scans_url, params: { scan: { description: @scan.description, quarterly_earnings: @scan.quarterly_earnings, title: @scan.title, yearly_earnings: @scan.yearly_earnings } }
    end
  ...
  test "should update scan" do
    patch scan_url(@scan), params: { scan: { description: @scan.description, quarterly_earnings: @scan.quarterly_earnings, title: @scan.title, yearly_earnings: @scan.yearly_earnings } }
